...
> Note: While a user ID *can* be added to an App Token during session generation. But, if no user ID was specified in the App Token creation, then privileges can NOT be added during session generation. 
